...
var jobInput = {
    ...
    template:{"version":"1",
    	...
    	"execute":{"type":"stackroute/javascript/build","input":{"WORKSPACE":"{{context.workspace}}"},"output":null,"context":null,"depends_on":["execute"]},
    	...
    	"code-review":{"type":"stackroute/ext/code-review","input":null,"output":{"payload":{"output":{"code-review":"{{OUTPUT}}"}}},"context":null,"depends_on":["eslint","htmlhint","code-coverage","whitebox","code-review","execute"]}}}
    };
