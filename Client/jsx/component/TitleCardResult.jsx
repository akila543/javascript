...
export default class TitleCardResult extends React.Component
{
	render()
	{
	return (
        ...
        <CardText>
           <Grid>
                <Row around="xs" center="xs">
                 ...
                 <Col >
                 <i className="material-icons" style={{fontSize: '38px',color:'#76FF03'}}>report</i>
                  <h3 style={{color:'#76FF03'}}>Report</h3>
                 </Col>
