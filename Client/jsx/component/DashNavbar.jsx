...
class DashNavbar extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div>
                <AppBar title={"Hello "+cookie.load("user")} onLeftIconButtonTouchTap={this.handleToggle} iconElementRight={< Link to = "/" > <FlatButton label="Logout" onClick={this.handleLogout} style={{color:'white'}}/> < /Link>}/>
